...
~~~
Error in ggplot(data = variants, aes(x = POS, y = DP)): could not find function "ggplot"
~~~
{: .error}
...
~~~
Error in ggplot(data = variants, aes(x = POS, y = DP, color = sample_id)): could not find function "ggplot"
~~~
{: .error}
...
> > 
> > ~~~
> > Error in ggplot(data = variants, aes(x = POS, y = MQ, color = sample_id)): could not find function "ggplot"
> > ~~~
> > {: .error}
> {: .solution}
{: .challenge}
...
> > 
> > ~~~
> > Error in ggplot(data = variants, aes(x = POS, y = QUAL, color = sample_id)): could not find function "ggplot"
> > ~~~
> > {: .error}
> {: .solution}
{: .challenge}
...
~~~
Error in ggplot(data = variants, aes(x = INDEL, fill = sample_id)): could not find function "ggplot"
~~~
{: .error}
...
>> 
>> ~~~
>> Error in ggplot(data = variants, aes(x = INDEL, color = sample_id)): could not find function "ggplot"
>> ~~~
>> {: .error}
> {: .solution}
{: .challenge}
